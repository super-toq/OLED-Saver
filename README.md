## Basti's OLED-Saver
Basti's OLED-Saver is a small tool that tries to prevent the device from standby, automatic suspending, sreen blanking and screen locking.
You can display a black fullscreen to protect the OLED from burn-in.  
